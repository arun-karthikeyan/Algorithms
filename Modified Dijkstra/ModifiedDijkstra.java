...
public class ModifiedDijkstra {
    ...
    private static PriorityQueue<ModifiedDijkstra.shortestPathDesc> getAllShortestPaths(
            int n, int source, int target, ArrayList<ArrayList<OutEdge>> adjList) {
        PriorityQueue<ModifiedDijkstra.OutEdge> minHeap = new PriorityQueue<ModifiedDijkstra.OutEdge>(
        ...
        PriorityQueue<ModifiedDijkstra.shortestPathDesc> shortestPaths = new PriorityQueue<ModifiedDijkstra.shortestPathDesc>(
                11,
                new java.util.Comparator<ModifiedDijkstra.shortestPathDesc>() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PriorityQueue<ModifiedDijkstra.shortestPathDesc> shortestPaths = getAllShortestPaths(
